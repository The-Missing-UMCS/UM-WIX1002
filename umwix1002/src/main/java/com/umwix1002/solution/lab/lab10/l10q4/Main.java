...
import com.umwix1002.solution.lab.lab10.l10q4.util.converter.PojoFacadeConverter;
...
import static com.umwix1002.solution.lab.lab10.l10q4.util.ConsoleLogger.logResult;

public class Main {
    private static final String APPOINTMENT = chainDir(LAB10, IO_FILES, "l10q4", "appointments.txt");
    private static final String INPUT = chainDir(LAB10, IO_FILES, "l10q4", "input.json");

    public static void main(String[] args) throws Exception {
        Repository repository = new Repository();
        List<Appointment> old = repository.load(APPOINTMENT);
        AppointmentService service = new AppointmentService(old);
        PojoFacadeConverter pojoFacadeConverter = new PojoFacadeConverter();

        List<Appointment> input = pojoFacadeConverter.convertToCollection(INPUT, Appointment.class);
        System.out.println(input.getFirst().getClass());
